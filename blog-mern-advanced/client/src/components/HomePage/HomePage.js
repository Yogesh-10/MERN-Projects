        ...
        <div className='relative container px-4 mx-auto'>
          <div className='flex flex-wrap items-center -mx-4 mb-10 2xl:mb-14'>
            <div className='w-full lg:w-1/2 px-10 mb-16 lg:mb-0'>
              ...
              <p className='mb-10 lg:mb-16 2xl:mb-24 text-xl text-gray-100'>
                Your post must be free from racism and unhealthy words
              </p>
              <a
                className='inline-block mb-20 px-12 py-5 text-lg text-white font-bold bg-blue-500 hover:bg-blue-600 rounded-full transition duration-200'
                href='/'
              >
                Join Community
              </a>
            ...
            <div className='lg:w-1/2 px-4'>
              <img className='max-w-xl' src={poster} alt={poster} />
            </div>
          </div>
        </div>
      </section>
